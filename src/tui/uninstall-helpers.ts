/**
 * Uninstall helpers — core uninstall logic extracted from screens/uninstall.ts.
 * Used by both the Ink TUI and the plain-text CLI path.
 */
...
import { section, t } from "./theme.js";
import {
  getPlatform,
  getRootDir,
  findOpenClaw,
